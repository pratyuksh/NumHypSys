...
import structure_mean_ldc as sm
...
def compute_structure_mean(lx, N, stencil, p):
    ...
    f = "../../output/uq_pincompNS_uq_ldc/velocity_mean_lx"+str(lx)+".json"
    vx, vy = load_data(f)
...
if __name__ == '__main__':
    ...
    # print(sm_data)
    filename = '../../output/uq_incompNS/structure_mean_ldc_lx'+str(lx_)+'.json'
